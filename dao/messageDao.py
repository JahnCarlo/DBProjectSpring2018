class MsgDAO:
    def __init__(self):
        #[msg id, text, likes, dislikes, author id, chat id]
        M1 = [25, "Hey, guys! Hope you're all well", 2, 0, 117, 3]
        M2 = [50, "Yo, John! I'm good. How about you?", 1, 0, 34, 3]
        M3 = [75, "You guys are too dumb.", 0, 2, 87, 3]
        M4 = [100, "Hello, ma'am", 0, 0, 117, 5]
        M5 = [125, "Hello, John", 0, 0, 10, 5]
    ...
    def getAuthorByMsgId(self, id):
        #With loop---- DOES NOT MAKE SENSE IF YOU ALSO WANT TO RETURN THE USER NAME & DOESN'T WORK
        #Could be fixed by making a list with the user name and the resulting user id
        # for r in self.data:
        #     if id == r[0]:
        #         return r[4]
        # return None
